...
@ddt.ddt
class TestXMLFlavor(providers.TestProviderBase):

    """Security Tests for any XML related Flavor vulnerablities"""

    def setUp(self):
        """
        Setup for the tests
        """
        super(TestXMLFlavor, self).setUp()
        self.reset_defaults()
    ...
    def test_xml_bomb_create_flavor(self):
        """
        Check whether it is possible to kill the application by
        creating a Flavor using XML bomb.
        """
...
<lolz>&lol9;</lolz>
    ...
    def tearDown(self):
        ...
        super(TestXMLFlavor, self).tearDown()
